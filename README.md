...
- 🖥️ Microprocessors (Raspberry Pi, BeagleBone, STM32MP1)  
- ⏱️ RTOS (FreeRTOS, Zephyr)  
- 💾 Firmware Development (C, C++, Python, Embedded Linux)  

### 🔌 Hardware Design
- 🛠️ PCB Design (Altium, KiCad)  
- 📐 Schematic & Circuit Design  
- 🌡️ Sensors & Actuator Integration  
- ⚡ Power Management & Signal Processing  

### 🛠️ Tools & Platforms
![STM32](https://img.shields.io/badge/STM32-00979D?style=flat-square&logo=STMicroelectronics&logoColor=white)
...
![PlatformIO](https://img.shields.io/badge/PlatformIO-1E90FF?style=flat-square&logo=PlatformIO&logoColor=white)
...
## 🚀 What I Do
- 🖥️ Design and develop **embedded firmware** for MCUs and MPUs  
- 🔧 Create **hardware prototypes** and PCBs for IoT and robotics  
- 🌐 Integrate **sensors, actuators, and communication modules** (UART, SPI, I2C, CAN)  
- ⚡ Optimize **performance, power, and reliability** in real-time systems  
...
### 🌟 Fun Fact
I love turning complex electronics concepts into **real-world, working devices**.  
From blinking LEDs 💡 to multi-core embedded systems 🖥️ — I enjoy making things **come alive!**  
